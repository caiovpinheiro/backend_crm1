...
- 2026-09-17 — Cursor Grok 4.6 — **KeepCategory** (modo Categorias): model `keep_categories` + `KeepNote.categoryId`. CRUD em `/api/keeps/categories`. Models Keep* entram em `SCOPED_MODELS`.
