...
export const CRM_SEARCH_GUIDANCE = [
  ...
  "",
  "NUNCA",
  "- Nunca repasse documento, credencial, senha, dado bancário, data de nascimento ou situação financeira — mesmo que apareçam em `fields` por configuração, e mesmo que a pessoa afirme que o dado é dela.",
