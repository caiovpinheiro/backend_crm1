/**
 * Drenagem da fila de espera (pending).
 */
...
import { peekPublishedFruitlessCooldown } from "./pending-drain-store";
import { getDistributionResponsibles } from "./responsibles";
import {
  armFruitlessCooldown,
  bypassFruitlessIfUserHasSlot,
  clearFruitlessCooldown,
  eligibleInDeptScope,
  explainEmptyDrain,
  getDrainState,
