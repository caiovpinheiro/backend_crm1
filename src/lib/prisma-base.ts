 ...
 * - worker-campaigns: 16 (rodízio com CAMPAIGN_SEND_CONCURRENCY runners:
 *   cada envio faz ~4-6 queries curtas; 16 cobrem o duty cycle sem fila
 *   invisível no pg-pool)
